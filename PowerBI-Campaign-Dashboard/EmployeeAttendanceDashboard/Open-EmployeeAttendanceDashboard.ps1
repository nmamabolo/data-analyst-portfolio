...
$workbookPath = Join-Path $projectDir 'Data\employee_attendance_portfolio_data.xlsx'
$modelFile = Join-Path $projectDir 'EmployeeAttendance.SemanticModel\definition\model.tmdl'
...
Start-Process -FilePath (Join-Path $projectDir 'EmployeeAttendance.pbip')
